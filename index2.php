  ...
  <body>
    ...
    <div id="reg-no">
        <div class="form-group row">
             ...
             <div class="col-sm-10">
                 <input type="number" name="reg_no" class="form-control" id="inputregno" placeholder="Registration Number">
             </div>
        ...
        <div class="form-row">
          ...
          <div class="form-group" id="Permanent-Address">
              ...
              <div class="form-row">
                 <div class="col-4 col-padding">
                    ...
                    <input type="text" class="form-control" placeholder="Nationality" name="p_nationality">
                 </div>
                 <div class="col-4 col-padding">
                    <label for="Stater">State</label>
                    <input type="text" class="form-control" placeholder="State" name="p_state">
                 </div> 
                 <div class="col-4 col-padding">
                    <label for="City">City</label>
                    <input type="text" class="form-control" placeholder="City" name="p_city">
                 </div>             
              </div>
              <div class="form-row">
                 <div class="col-4 col-padding">
                    <label for="District">District</label>
                    <input type="text" class="form-control" placeholder="District" name="p_district">
                 </div>
                 <div class="col-4 col-padding">
                    <label for="Country">Country</label>
                    <input type="text" class="form-control" placeholder="Country" name="p_country">
                 </div> 
                 <div class="col-4 col-padding">
                    <label for="Pincode">Pincode</label>
                    <input type="Number" class="form-control" placeholder="Pincode" name="p_pincode">
                 </div>             
              </div>
              <div class="col-12 col-padding">
                <label for="Address">Address</label>
                <input type="text" class="form-control" placeholder="Address" name="p_address">
              </div>
          </div>
          <div class="form-group" id="Correspondance-Address">
              <div class="row">
                ...
                <div class="col-auto">
                  <button type="submit" class="btn btn-outline-primary">Same as Permanent Address</button>
                </div>
              </div>
              <div class="form-row">
                 <div class="col-4 col-padding">
                    <label for="Nationalityr">Nationality</label>
                    <input type="text" class="form-control" placeholder="Nationality" name="c_nationality">
                 </div>
                 <div class="col-4 col-padding">
                    <label for="Stater">State</label>
              ...
              <div class="form-row">
                 ...
                 <div class="col-4 col-padding">
                    <label for="Pincode">Pincode</label>
                    <input type="Number" class="form-control" placeholder="Pincode" name="c_pincode">
                 </div>             
              </div>
              <div class="col-12 col-padding">
                <label for="Address">Address</label>
      ...
      <div>
       ...
       <div class="form-row">
         <div class="col-12 col-padding">
           ...
           <input type="text" class="form-control" placeholder="e.g Initial Page, All pages" name="size">
         </div>
       </div>
       <div class="form-row">
         <div class="col-12 col-padding">
        ...
        <div class="form-row">
         <div class="col-12 col-padding">
           <label for="Accompny Material">Accompny Material:</label>
           <input type="text" class="form-control" placeholder="Accompny Material" name="accompny_material">
         </div>
       </div>
       <div class="form-row">
         <div class="col-12 col-padding">
